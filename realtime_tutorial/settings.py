...
DATABASES = {
    'default': {
        ...
        'NAME': 'realtime_example',                      # Or path to database file if using sqlite3.
...
SECRET_KEY =   'a^&%6yp#2eudk%+5v-7tkhn+hxfm2_zmm83rpp&!oe7(n@-tta'
